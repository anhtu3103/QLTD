...
namespace WindowsFormsApplication1.src.Services
{
    class connVTTD_UngVien : connDB
    {
        ...
        public bool UpdateTrangThaiDeCu(List<clsUngVienUngTuyen> dsuvUpdate)
        {
        ...
        public bool UpdateTrangThaiPD(List<clsUngVienUngTuyen> dsuvUpdate)
        {
            System.Data.Common.DbTransaction suaTran = db.Connection.BeginTransaction();
            try
            {
        ...
        public bool UpdateTrangThaiDeCu_False(List<clsUngVienUngTuyen> dsuvUpdate)
        {
            System.Data.Common.DbTransaction suaTran = db.Connection.BeginTransaction();
            try
            {
        ...
        public bool UpdateTrangThaiPD_False(List<clsUngVienUngTuyen> dsuvUpdate)
        {
            System.Data.Common.DbTransaction suaTran = db.Connection.BeginTransaction();
            try
            {
